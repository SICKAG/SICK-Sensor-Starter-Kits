...
<table style="border-collapse: collapse; width: 100%;">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Advanced</td>
      <td>2 Hours</td>
      <td>Chocolate Bar<br>3D print files <a href="https://sick.com/de/en/downloads/media/swp682086">sick.com/de/en/downloads/media/swp682086</a><br>OR any other chocolate bar / packed grocery</td>
    </tr>
    <tr>
      <td>3</td>
    ...
    <tr>
      ...
      <td>Advanced</td>
      <td>1 Hour</td>
      <td>Empty boxes<br>Contaminations (e.g. pieces of paper, small rocks, hair, etc.)</td>
    </tr>
    <tr>
      <td>5</td>
      ...
      <td>Expert</td>
      <td>4 Hours</td>
      <td><strong>Hardware:</strong> Raspberry Pi 5, Micro HDMI (cable/adapter), Display, keyboard, mouse<br><strong>Software:</strong> Visual Studio Code, Raspberry Pi Imager, Python</td>
    </tr>
    <tr>
      <td>6</td>
